    ...
    return (
        <div className="navbar__container">
            ...
            <div className={`sidebar ${isSidebarOpen ? 'sidebar--open' : ''}`}>
                <button className="sidebar__close-button" onClick={toggleSidebar}>×</button>
                <div className="sidebar__content">
                    <Link to="/liked-shows" className="sidebar__liked-shows-link">
                        <Badge style={{ backgroundColor: 'red' }} count={likedShowsCount} showZero>
                            {t('Liked Shows')}
                        </Badge>
                    </Link>
                    <select onChange={changeLanguage} className="sidebar__language-select">
                        <option value="en">{t('English')}</option>
                        <option value="ru">{t('Russian')}</option>
                    </select>
                </div>
